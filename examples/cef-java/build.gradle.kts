...
tasks.withType<JavaCompile>().configureEach {
    // Specify Java target compatibility for JaCoCo compatibility
    options.release = 21  // Set target to Java 21 for JaCoCo compatibility with v0.8.12
}
...
tasks.jacocoTestReport {
    ...
    // Only measure coverage of generated code
...
tasks.jacocoTestCoverageVerification {
    ...
    violationRules {
        rule {
            limit {
                minimum = "1.00".toBigDecimal()  // 100% coverage required for generated code
            }
        }
    }
}
